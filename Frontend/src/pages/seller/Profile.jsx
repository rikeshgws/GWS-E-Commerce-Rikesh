...
function SellerProfile() {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (result.data.sellerProfile.success) {
        const data = JSON.parse(result.data.sellerProfile.data)
        setProfile(data)
        setFormData({
          name: data.name || '',
          phone: data.phone || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.data.sellerUpdateProfile.success) {
        alert('Profile updated successfully!')
        setEditing(false)
        fetchProfile()
      } else {
        alert(result.data.sellerUpdateProfile.message)
      }
    } catch (err) {
